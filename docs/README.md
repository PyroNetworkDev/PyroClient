...
<h1 align="center">Pyro Client</h1>
...
| -------- | ---- |
| Windows x64 | [Pyro-Client-win-x64.exe](../../..//releases/latest/download/Pyro-Client-win-x64.exe) |
| macOS x64/arm64(silicon) | [Pyro-Client-mac-universal.zip](../../..//releases/latest/download/Pyro-Client-mac-universal.zip) |
| Linux x64 | [Pyro-Client-linux-x86_64.AppImage](../../..//releases/latest/download/Pyro-Client-linux-x86_64.AppImage) |
---
